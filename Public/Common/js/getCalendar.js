...
//阳历
function setTime(){
	// var time_normal = documemt.getElementById('time_normal');
	var day = "";
	var month = "";
	var ampm = "";
	var ampmhour = "";
	...
	if(myweekday == 0)
		...
		weekday = " 星期六 ";
	time_normal.innerHTML = year+"年"+mymonth+"月"+myday+"日 - "+myHours+":"+myMinutes+":"+mySeconds+" - "+weekday;
...
if (yy<100) yy = "19"+yy;
function showCal(){
	// var time_lunar = documemt.getElementById('time_lunar');
	time_lunar.innerHTML = GetLunarDay(yy,mm,dd);
}