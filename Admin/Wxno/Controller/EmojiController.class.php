...
class EmojiController extends Controller{
	...
	function emoji_convert($text, $map){
		return str_replace(array_keys($this->emoji_maps[$map]), $this->emoji_maps[$map], $text);
	}

	function emoji_get_name($unified_cp){
		return $this->emoji_maps['names'][$unified_cp] ? $this->emoji_maps['names'][$unified_cp] : '?';
	}
	...
	public function emoji_to_string($text,$replaceStr="#"){
		$text=str_ireplace(array_keys($this->emoji_maps['names']), $this->coverString($replaceStr), $this->coverString($text));
	...
	public function test(){
		...
		//风信jeff加个笑脸表情
		// $str="%E9%A3%8E%E4%BF%A1Jeff%F0%9F%98%99%F0%9F%98%9B%F0%9F%98%9C%F0%9F%98%99";
    	// $str=urldecode($str);
		$str = "🍇少油的炖菜菜谱，绝对不用担心吃下去太多油！";
    	
    	echo $this->emoji_to_string($str);
	}
	public function tt(){
		echo 'abc';
	}
