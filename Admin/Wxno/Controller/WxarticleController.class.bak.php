	...
	public function artEdit(){
		...
		$data_wxartSave = array(
			'data' => array(
				...
				'wx_id' => $params['wx_id'],
				'art_real_link' => htmlspecialchars_decode($params['art_real_link']),
		...
		if ($params['save']=='1'){
			...
			if (in_array('upd_title', $params['upd_info'])){
				$arr_get = $this->getContentByUrl(htmlspecialchars_decode($params['art_real_link']));
				...
				if ($arr_art[$i]!=''){
					...
					$data_wxartSave = array(
						'data' => array(
							'wx_id' => $params['wx_id'],
							'art_title' => str_replace('"', "'", $arr_get['art_title']),
							'art_real_link' => htmlspecialchars_decode($arr_art[$i]),
							'art_pic' => $arr_get['art_pic'],
							'art_desc' => $arr_get['art_desc'],
							'art_content' => $arr_get['art_content'],
							'add_time' => date('Y-m-d H:i:s',time()),
